        ...
        try:
            if var3.get()>len(videos):
                ...
                for i in range(var3.get()):
                    quality = videos[i]
                    location = f'C://Users//svk76//PycharmProjects//Everything_Downloader//App_Downloads//{a4}//'
...
if num==1:
    ...
    try:
        for i,url in enumerate(urls):
            a.download_image(f'C://Users//svk76//PycharmProjects//Everything_Downloader//App_Downloads//{a4}//',  url, str(i) + f".{var1.get()}")
    except Exception as e:
        print(e)
    a.quit()
